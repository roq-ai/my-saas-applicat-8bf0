...
-- CreateTable
CREATE TABLE "pose_estimation_result" (
    "id" UUID NOT NULL DEFAULT uuid_generate_v4(),
    ...
    CONSTRAINT "pose_estimation_result_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "pose_estimation_result" ADD CONSTRAINT "pose_estimation_result_team_member_id_fkey" FOREIGN KEY ("team_member_id") REFERENCES "team_member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
