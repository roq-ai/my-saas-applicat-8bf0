...
import { getPoseEstimationResultById } from 'apiSdk/pose-estimation-results';
...
function PoseEstimationResultViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Pose Estimation Result Detail View
          </Text>
          {hasAccess('pose_estimation_result', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/pose-estimation-results/edit/${data?.id}`} passHref legacyBehavior>
              <Button
